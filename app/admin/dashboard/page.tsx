...
import { employee as initialEmployeeData } from "@/lib/cardData";
import { AdminShiftSchedule } from '@/components/AdminShiftSchedule';

const EmployeeShiftUpdater = () => {
...
export default EmployeeShiftUpdater;
